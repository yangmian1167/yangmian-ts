    ...
    pages            =
    {

		{
            ...
            },
            {
                ["id"] = "game_main",
                ["type"] = "RadioGroup",
                ["list"] = "0回城,1换服,2新手,3兑券,4升城,5开图,6(升城|遗迹|采矿),7(升城|采矿),8~,9遗迹采矿,10战争学院,11清理,12~,13~,14~,15发广告",
                ["select"] = "0",
            },
			{
                ["type"] = "Label",
            ...
            },
            {
                ["id"] = "setting",
                ["type"] = "CheckBoxGroup",
                ["list"] = "0邮件,1宝箱,2任务,3*爵位*,4战损,5强制切换,6-,7~,8~,9~,10研究开关,11~,12商店稀有,13优升主城,14地图,15优先右侧,16备份名,17~,18商店木材,19开背包,20遗迹,21魔镜,22活动",
                ["images"] = "",
                ["select"] = "",
                ["scale"] = 0.4,
            },
