...
t['完善信息界面-相机胶卷1']={ 0xf7f7f7, "-33|-12|0xffffff,-65|-25|0x222222,131|21|0x222222,133|-22|0x222222", 90, 266, 50, 522, 123 } --多点找色9系统
	...
	while os.time()-timeline < outTimes do
		if active(var.appbid,5) then
			...
			elseif d('已经注册-世纪侍缘') or d('已经注册-免费打招呼') or d('已经注册-上传头像',true) then
				...
				dxcode.addBlack()
				return false
			elseif d('完善信息界面-相机胶卷')or d('完善信息界面-相机胶卷1') then
